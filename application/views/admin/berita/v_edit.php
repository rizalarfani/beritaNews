            ...
            <div class="box box-info">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Judul Berita" name="judul_berita" value="<?php echo $list_berita->judul_berita ?>">
                    </div>
                    <div class="form-group">
                        <label for="Isi Berita"><i class="fa fa-star text-red"></i> Isi Berita</label></label>
                        <textarea class="textarea form-contro" id="isi_berita" name="isi_berita" placeholder="Place some text here" style="width: 100%; height: 450px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $list_berita->isi_berita ?></textarea>
                    </div>
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select name="kategori" id="kategori" class="form-control">
                                    <?php foreach ($list_kategori as $data) : ?>
                                        <?php $selected = ($data->id == $list_berita->id_ketegori) ? 'selected' : '' ?>
                                        <option <?php echo $selected ?> value="<?php echo $data->id ?>"><?php echo $data->nama_kategori ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
